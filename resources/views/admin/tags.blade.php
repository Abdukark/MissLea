      ...
      <div class="card mb-3">
        <div class="card-body">
            ...
            <div class="table-responsive">
              <form action="/admin/tags" class="form-inline" method="POST">
                @csrf
                ...
                <table id="zero_config" class="table table-striped table-bordered text-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                              <a href="{{route('tag.destroy',$tag->id)}}"><img src="{{ asset('img/Dashboard/delete-button-svgrepo-com.svg') }}" alt="Delete" width="20px"></a>
                            </td>
                        </tr>
                        @empty
                        <tr>
...
<script>
  var element = document.getElementById("navtag");
