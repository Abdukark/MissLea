...
@section('content')
    ...
    <div id="page-content">
    	<!--Page Title-->
    	<div class="page section-header text-center pt-5">
        	...
        	<div class="row">
                                ...
                                <tr class="cart__row border-bottom line1 cart-flex border-top">
                                    ...
                                    <td class="cart__update-wrapper cart-flex-item text-right">
                                        <div class="cart__qty text-center">
                                            <div class="qtyField">
                                                <a class="qtyBtn minus text-decoration-none" href="javascript:void(0);">-</a>
                                                <input class="cart__qty-input qty" type="text" name="updates[]" id="qty" value="1" pattern="[0-9]*">
                                                <a class="qtyBtn plus text-decoration-none" href="javascript:void(0);">+</a>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="text-center small--hide"><a href="#" class="btn btn--secondary cart__remove" title="Remove tem">X</a></td>
                                </tr>
                                <tr class="cart__row border-bottom line1 cart-flex border-top">
                                    <td class="cart__image-wrapper cart-flex-item">
                ...
                <div class="col-12 col-sm-12 col-md-4 col-lg-4 cart__footer">
                    ...
                    <div class="solid-border">
                      ...
                      <div class="paymnet-img"><img src="{{asset('img/Cart/payment-img.jpg')}}" alt="Payment"></div>
                    </div>
...
@section('scripts')
<!-- Including Jquery -->
<script type="text/javascript" src="{{asset('js/js/vendor/jquery-3.3.1.min.js')}}"></script>
<script type="text/javascript" src="{{asset('js/js/vendor/jquery.cookie.js')}}"></script>
<script type="text/javascript" src="{{asset('js/js/vendor/modernizr-3.6.0.min.js')}}"></script>
<script type="text/javascript" src="{{asset('js/js/vendor/wow.min.js')}}"></script>
...
<script type="text/javascript" src="{{asset('js/js/lazysizes.js')}}"></script>
